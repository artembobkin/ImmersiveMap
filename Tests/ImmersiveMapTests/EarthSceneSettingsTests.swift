...
final class EarthSceneSettingsTests: XCTestCase {
    func testDefaultEarthSceneIsEnabledWithRealtimeSun() {
        ...
        XCTAssertEqual(earth.sun.glowIntensity, 0.5, accuracy: 0.0001)
        XCTAssertEqual(earth.sun.edgeGlareIntensity, 0.0, accuracy: 0.0001)
        XCTAssertEqual(earth.sun.limbHaloIntensity, 0.9, accuracy: 0.0001)
        XCTAssertEqual(earth.sun.limbHaloWidth, 0.05, accuracy: 0.0001)
    }
