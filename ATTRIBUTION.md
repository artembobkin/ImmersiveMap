...
With the built-in tiles the credit is **© OpenStreetMap**, linking to [openstreetmap.org/copyright](https://www.openstreetmap.org/copyright). Keep the map data credit visible wherever the map is. Crediting ImmersiveMap itself is not required.
