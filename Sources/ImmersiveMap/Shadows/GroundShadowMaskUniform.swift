...
/// inverse projection-view and samples the shadow map there once, so the
/// blended ground layers can read one value instead of each sampling the map
/// again for the same pixel.
