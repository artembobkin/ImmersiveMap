...
Running examples: [`Examples/ImmersiveMapCustomTilesMac`](../../Examples/ImmersiveMapCustomTilesMac) implements a full `ImmersiveMapVectorTileStyle` by hand; [`Examples/ImmersiveMapMapboxMac`](../../Examples/ImmersiveMapMapboxMac) restyles a built-in configuration with the builder methods; the **Style** section of [`Examples/ImmersiveMapSettingsMac`](../../Examples/ImmersiveMapSettingsMac) swaps day, night and blueprint palettes for the built-in provider and restyles the attribution badge next to them.
