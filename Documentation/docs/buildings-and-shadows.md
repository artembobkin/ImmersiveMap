...
Running example: [`Examples/ImmersiveMapBuildingsMac`](../../Examples/ImmersiveMapBuildingsMac) switches the three extrusion modes at street level and drives the sun angle, strength, map resolution and coverage live.
